...
if not os.path.exists('example'):
    os.makedirs('example')
os.chdir('example')
raw_file = 'C:\\Users\\ning\\Downloads\\training set\\suj10_d1_nap.vhdr'
annotation_file = 'C:\\Users\\ning\\Downloads\\training set\\suj10_d1final_annotations.txt'

raw = mne.io.read_raw_brainvision(raw_file,preload=True,scale=1e6)
annotation = pd.read_csv(annotation_file)
montage = "standard_1020"
montage = mne.channels.read_montage(montage)
raw.set_montage(montage)
raw.set_channel_types({'LOc':'eog','ROc':'eog','Aux1':'stim'})
