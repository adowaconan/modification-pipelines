...
file_to_read = "D:\\NING - spindle\\training set\\suj29_l2nap_day2.fif"
raw=mne.io.read_raw_fif(file_to_read,add_eeg_ref=False,preload=True)#loading the preprocessed data
raw.resample(500)
raw.filter(11,16)
channelList = ['F3','F4','C3','C4','O1','O2']
annotation = pd.read_csv('D:\\NING - spindle\\training set\\suj29_nap_day2_edited_annotations.txt')
...
result.to_csv(filename,index_label=False)